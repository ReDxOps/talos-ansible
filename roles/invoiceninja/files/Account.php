...
class Account extends BaseModel
{
    ...
    {
        // BYPASS: Force White Label and Remove Created By features
        if ($feature === self::FEATURE_WHITE_LABEL || $feature === self::FEATURE_REMOVE_CREATED_BY) {
            return true;
        }
        ...
        switch ($feature) {
            ...
            case self::FEATURE_MORE_CLIENTS:
                return true; // Use simple true for all these as well if requested "unlock everything"
